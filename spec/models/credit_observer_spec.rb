...
describe CreditObserver do
  it "increments a countable object's credit counts after credit creation" do
    ...
    @countable.counter.directing_credits.should == 0

    @movie = Movie.make!
    @movie.counter.directing_credits.should == 0

    @countable.directing_credits.create :movie => @movie, :job => 'Director'
    @countable.reload
    @movie.reload
    @countable.counter.directing_credits.should == 1
    @movie.counter.directing_credits.should == 1
  end
